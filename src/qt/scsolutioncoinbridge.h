#ifndef SCSOLUTIONCOINBRIDGE_H
#define SCSOLUTIONCOINBRIDGE_H

class SCSolutionCoinGUI;
...
class SCSolutionCoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit SCSolutionCoinBridge(SCSolutionCoinGUI *window, QObject *parent = 0);
    ~SCSolutionCoinBridge();
...
private:
    ...
    friend class SCSolutionCoinGUI;
