...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::SCSO).toInt();
    ...
    fAutoRedeemSCSolutionCoin = settings.value("fAutoRedeemSCSolutionCoin", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemSCSolutionCoin:
            return fAutoRedeemSCSolutionCoin;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemSCSolutionCoin: return "AutoRedeemSCSolutionCoin";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::SCSO).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemSCSolutionCoin: {
            fAutoRedeemSCSolutionCoin = value.toBool();
            settings.setValue("fAutoRedeemSCSolutionCoin", fAutoRedeemSCSolutionCoin);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemSCSolutionCoin() { return fAutoRedeemSCSolutionCoin; }
