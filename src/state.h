// Copyright (c) 2014 The Scsolutioncoin Developers
...
const int64_t GENESIS_BLOCK_TIME = 1516190701;
...
static const int64_t MAX_MONEY = 668000000 * COIN;        //  105 million SCSolutionCoin Total
static const int64_t COIN_YEAR_REWARD = 5 * CENT;       //  69% 1st Year
static const int64_t SCOIN_YEAR_REWARD = 5 * CENT;     //  20% 1st halving
static const int64_t CCOIN_YEAR_REWARD = 5 * CENT;     //  10% 2nd halving
static const int64_t KCOIN_YEAR_REWARD = 5 * CENT;       //  5% 3rd halving
static const int64_t ICOIN_YEAR_REWARD = 5 * CENT;    //  2.5% 4th halving
static const int64_t OCOIN_YEAR_REWARD = 5 * CENT;       //  2% 5th halving
static const int64_t DCOIN_YEAR_REWARD = 5 * CENT;       //  1% 6th halving
static const int64_t RCOIN_YEAR_REWARD = 5 * CENT;    //  0.5% 7th halving
static const int64_t ECOIN_YEAR_REWARD = 5 * CENT;  //   0.25% 8th halving
static const int64_t ACOIN_YEAR_REWARD = 5 * CENT;    //   0.1% 9th halving
static const int64_t MCOIN_YEAR_REWARD = 5 * CENT;  //   0.05% 10th halving
static const int64_t ZCOIN_YEAR_REWARD = 5 * CENT;  //   0.03% 11th halving and onwards
